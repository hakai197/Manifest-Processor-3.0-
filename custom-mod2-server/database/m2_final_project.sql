...
CREATE TABLE Assignments (
    ...
    CONSTRAINT FK_Assignment_Unloader FOREIGN KEY (employee_id) REFERENCES Unloader(employee_id) ON DELETE CASCADE,
    CONSTRAINT FK_Assignment_Trailer FOREIGN KEY (trailer_id) REFERENCES Trailer(trailer_id) ON DELETE CASCADE
);
...
-- Assign some unloaders to trailers
INSERT INTO Assignments (employee_id, trailer_id, door_number, status) VALUES

(1, 1, 'Door 7', 'Assigned'),
(2, 2, 'Door 34', 'Assigned'),
(3, 3, 'Door 11', 'Assigned');
